...
export enum EventName {
    ...
    OPEN_DATAWRANGLER_FROM_OUTPUT_REQUEST = 'OPEN_DATAWRANGLER_FROM_OUTPUT_REQUEST_EX',
    OPEN_DATAWRANGLER_FROM_OUTPUT_ERROR = 'OPEN_DATAWRANGLER_FROM_OUTPUT_ERROR_EX',
    OPEN_DATAWRANGLER_FROM_OUTPUT_SUCCESS = 'OPEN_DATAWRANGLER_FROM_OUTPUT_SUCCESS_EX'
}
