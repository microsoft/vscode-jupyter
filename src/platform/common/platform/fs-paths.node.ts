...
export const homePath = Uri.file(untildify('~'));
...
export function getDisplayPathFromLocalFile(file: string | undefined) {
    return getDisplayPath(file ? Uri.file(file) : undefined);
}
