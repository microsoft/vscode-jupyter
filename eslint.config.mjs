...
export default [
    // Base configuration for TypeScript files
    {
        ...
        ignores: ['*.js', 'vscode.*.d.ts', 'vscode.d.ts', 'types/**/*', 'build/**/*']
    },
    
    // Override for build files and gulpfile
    {
    ...
    // Override for TypeScript definition files
    {
        files: ['src/*.d.ts'],
        rules: {
