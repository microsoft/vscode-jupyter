...
function addLoggingForCI() {
    ...
    const sourceFile = path.join(constants.ExtensionRootDir, 'build/misc/default.js');
    const fileContents = fs.readFileSync(sourceFile, { encoding: 'utf8' });
    fs.writeFileSync(filePath, fileContents);
    console.log('Updated default.js');
}
