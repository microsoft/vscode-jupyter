...
import type { VariableView as VariableViewType } from './variableView';
...
export class VariableViewProvider implements IVariableViewProvider {
    ...
    private get activeVariableView(): Promise<VariableViewType> {
        if (!isTestExecution()) {
        ...
        this.activeVariableViewPromise = createDeferred<VariableViewType>();
        return this.activeVariableViewPromise.promise;
    }
    private activeVariableViewPromise?: Deferred<VariableViewType>;

    private variableView?: VariableViewType;
    ...
    public async resolveWebviewView(
        ...
        const variableViewModule = await import('./variableView');
        this.variableView = new variableViewModule.VariableView(
            this.configuration,
