...
export enum Telemetry {
    ...
    JupyterKernelApiSessionPEMUsage = 'DATASCIENCE.JUPYTER_KERNEL_API_SESSION_PEM_USAGE',
    JupyterKernelApiKernelPEMUsage = 'DATASCIENCE.JUPYTER_KERNEL_API_KERNEL_PEM_USAGE',
