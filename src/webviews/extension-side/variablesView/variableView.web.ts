...
import { VariableViewMessageListener } from './variableViewMessageListener.web';
...
import { WebviewViewHost } from '../webviewViewHost.web';
...
export class VariableView extends WebviewViewHost<IVariableViewPanelMapping> implements IDisposable {
    ...
    constructor(
        ...
        const variableViewDir = path.join(
