...
require('expose-loader?exposes=jQuery!slickgrid/lib/jquery-1.11.2.min');

// eslint-disable-next-line @typescript-eslint/no-var-requires, @typescript-eslint/no-require-imports
require('slickgrid/lib/jquery-1.11.2.min');

// eslint-disable-next-line @typescript-eslint/no-var-requires, @typescript-eslint/no-require-imports
require('expose-loader?exposes=jQuery.fn.drag!slickgrid/lib/jquery.event.drag-2.3.0');
