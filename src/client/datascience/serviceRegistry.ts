...
import { ExportFormat, INbConvertExport, IExportDialog, IExportManager, IImportManager } from './export/types';
...
export function registerTypes(serviceManager: IServiceManager, inNotebookApiExperiment: boolean) {
    ...
    serviceManager.addSingleton<ExportManager>(ExportManager, ExportManager);
    serviceManager.addBinding(ExportManager, IExportManager);
    serviceManager.addBinding(ExportManager, IImportManager);
