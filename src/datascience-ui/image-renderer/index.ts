...
// class CellOutput{
//     constructor(private readonly props: ICellOutputProps) {
//     }
//     public render() {
...
//         let divStyle = 'overflow:scroll; position:relative; '; // `overflow:scroll` is the default style used by Jupyter lab.
//         const imgSrc =
...
//             divStyle = `${divStyle}background-color:${customMetadata.needs_background === 'light' ? 'white' : 'black'}`;
//         }
//         // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
//         );
//         const html = `<div className='display' style='${divStyle}' onMouseOver={onMouseOver} onMouseOut={onMouseOut}>
//                 <button
//                     ref={this.saveAsIcon}
