...
import { JupyterAPI as PythonInterationAPI } from '../../api.pythonIntegration';
...
export interface IExtensionApi extends JupyterAPI, UnStableJupyterAPI, ProposedJupyterAPI, PythonInterationAPI {}
