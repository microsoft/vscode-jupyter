...
import { IDataWranglerJupyterVariableDataProvider } from './types';

@injectable()
export class DataWranglerJupyterVariableDataProvider implements IDataWranglerJupyterVariableDataProvider {
        ...
        if (variable) {
            ...
            dataFrameInfo = {
                columns: variable.columns
                    ? DataWranglerJupyterVariableDataProvider.getNormalizedColumns(variable.columns)
                    : variable.columns,
                indexColumn: variable.indexColumn,
                rowCount: variable.rowCount,
                dataDimensionality: variable.dataDimensionality,
                shape: DataWranglerJupyterVariableDataProvider.parseShape(variable.shape),
                sliceExpression,
                type: variable.type,
