	...
	private renderOperationControls = () => {
		switch (this.state.operationType) {
			case ColumnTransformation.Drop:
				return <DropColumnsSection headers={this.props.headers} options={this.props.options} submitCommand={this.props.submitCommand} />;
			case ColumnTransformation.Rename:
				return <RenameColumnsSection headers={this.props.headers} options={this.props.options} submitCommand={this.props.submitCommand} />;
			case ColumnTransformation.Normalize:
				return <NormalizeDataSection headers={this.props.headers} options={this.props.options} submitCommand={this.props.submitCommand} />;
			case ColumnTransformation.DropNA:
				return <DropMissingColumnsSection headers={this.props.headers} options={this.props.options} submitCommand={this.props.submitCommand} />
		}
	}
