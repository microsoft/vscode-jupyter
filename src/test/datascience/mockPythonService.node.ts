...
export class MockPythonService implements IPythonExecutionService {
    ...
    public getExecutablePath(): Promise<string> {
        return Promise.resolve(this.interpreter.path.fsPath);
    }
    ...
    public execObservable(args: string[], options: SpawnOptions): ObservableExecutionResult<string> {
        return this.procService.execObservable(this.interpreter.path.fsPath, args, options);
    }
    public execModuleObservable(
        ...
        return this.procService.execObservable(this.interpreter.path.fsPath, ['-m', moduleName, ...args], options);
    }
    public exec(args: string[], options: SpawnOptions): Promise<ExecutionResult<string>> {
        return this.procService.exec(this.interpreter.path.fsPath, args, options);
    }

    public execModule(moduleName: string, args: string[], options: SpawnOptions): Promise<ExecutionResult<string>> {
        return this.procService.exec(this.interpreter.path.fsPath, ['-m', moduleName, ...args], options);
    }

    public addExecResult(args: (string | RegExp)[], result: () => Promise<ExecutionResult<string>>) {
        this.procService.addExecResult(this.interpreter.path.fsPath, args, result);
    }
    ...
    public addExecModuleResult(
        ...
        this.procService.addExecResult(this.interpreter.path.fsPath, ['-m', moduleName, ...args], result);
    }

    public addExecObservableResult(args: (string | RegExp)[], result: () => ObservableExecutionResult<string>) {
        this.procService.addExecObservableResult(this.interpreter.path.fsPath, args, result);
    }
    ...
    public addExecModuleObservableResult(
        ...
        this.procService.addExecObservableResult(this.interpreter.path.fsPath, ['-m', moduleName, ...args], result);
    }
    ...
    public getExecutionInfo(args: string[]) {
        return buildPythonExecInfo(this.interpreter.path.fsPath, args);
    }
}
