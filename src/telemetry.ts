...
type IBasePropertyData = {
    /**
     * SystemMetaData is what allows us to identify a particular user across time, although we don't know the actual identity of the user. machineId or instanceId fall in this category.
