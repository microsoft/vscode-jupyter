...
Based on the structure of the contents in `.github/kernel-instructions.md`, You will be asked to review a certain folder/file of the codebase.

Now create a file named `.github/instructions/<feature area>>.instructions.md` based on the above documentation:
...
- Pay particular attention to interactions of components within this feature area
