...
export function createRemoteConnectionInfo(uri: string, serverUri?: IJupyterServerUri): IJupyterConnection {
    const url = new URL(uri);
    const providerId = extractJupyterServerHandleAndId(uri)?.id;
