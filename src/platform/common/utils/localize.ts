...
export namespace DataScience {
    ...
    export const startingJupyterServer = l10n.t('Starting Jupyter Server...');
    export const stoppingJupyterServer = l10n.t('Stopping Jupyter Server...');
    export const cleaningUpPersistentServers = l10n.t('Cleaning up Persistent Servers...');
    export const noPersistentServersRunning = l10n.t('No persistent Jupyter servers are currently running');
    export const noPersistentServersToConnectTo = l10n.t('No persistent servers available to connect to');
    export const noPersistentServersToCleanup = l10n.t('No persistent servers to clean up');
    export const selectPersistentServerToStop = l10n.t('Select a persistent server to stop');
    export const selectPersistentServerToConnect = l10n.t('Select a persistent server to connect to');
    export const persistentServerStopped = l10n.t('Persistent server stopped successfully');
    export const persistentServersCleanedUp = l10n.t('Persistent servers cleaned up successfully');
    export const openInBrowser = l10n.t('Open in Browser');
    export const copyUrl = l10n.t('Copy URL');
    export const urlCopiedToClipboard = l10n.t('URL copied to clipboard');
    export const cleanupServers = l10n.t('Clean up Servers');
    export const failedToStartJupyterServer = (error: string) => l10n.t('Failed to start Jupyter server: {0}', error);
    export const failedToStopJupyterServer = (error: string) => l10n.t('Failed to stop Jupyter server: {0}', error);
    export const failedToConnectToPersistentServer = (error: string) => l10n.t('Failed to connect to persistent server: {0}', error);
    export const failedToCleanupPersistentServers = (error: string) => l10n.t('Failed to cleanup persistent servers: {0}', error);
    export const persistentServerInfo = (name: string, url: string) => l10n.t('Persistent Server: {0}\\n\\nURL: {1}\\n\\nThis server is running independently and can be used across VS Code sessions.', name, url);
    export const confirmCleanupPersistentServers = (count: number) => l10n.t('This will clean up {0} persistent server entries. Dead servers will be removed, but running servers will be left intact. Continue?', count);
