...
import { JUPYTER_POWERTOYS_EXTENSION_ID, JVSC_EXTENSION_ID } from '../platform/common/constants';
...
export class NotebookKernelExecution implements INotebookKernelExecution {
    ...
    public async *executeCode(
        ...
        if (extensionId === JVSC_EXTENSION_ID || extensionId === JUPYTER_POWERTOYS_EXTENSION_ID) {
