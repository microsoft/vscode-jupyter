...
_VSCODE_startRow = _VSCODE_builtins.max(_VSCode_JupyterStartRow, 0)  # type: ignore # noqa: F821
_VSCODE_endRow = _VSCODE_builtins.min(
    _VSCode_JupyterEndRow, _VSCODE_targetVariable["rowCount"]  # noqa: F821 # type: ignore
)
