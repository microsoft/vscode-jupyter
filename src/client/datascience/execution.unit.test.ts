...
import { PersistentState, PersistentStateFactory } from '../common/persistentState';
...
import { MockJupyterServer } from '../../test/datascience/mockJupyterServer';
    ...
    test('Working notebook and commands found', async () => {
        ...
        try {
            await assert.isFulfilled(
                jupyterExecutionFactory.connectToNotebookServer({ ui, resource: undefined, localJupyter: true }, token),
    ...
    test('Failing notebook throws exception', async () => {
        ...
        try {
            await assert.isRejected(
                execution.connectToNotebookServer({ ui, resource: undefined, localJupyter: true }, token),
