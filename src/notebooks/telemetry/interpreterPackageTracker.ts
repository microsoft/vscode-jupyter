...
import { IControllerRegistry, IVSCodeNotebookController } from '../controllers/types';
...
export class InterpreterPackageTracker implements IExtensionSingleActivationService {
    ...
    constructor(
        ...
        @inject(IControllerRegistry) private readonly notebookControllerManager: IControllerRegistry
    ) {}
