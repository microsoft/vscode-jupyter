...
import type { VariableView } from './variableView';
...
export class VariableViewProvider implements IVariableViewProvider {
    ...
    public async resolveWebviewView(
        ...
        // TODO: Protect accidental importing of variableView
        const variableViewCtor = (await import('./variableView')).VariableView;
        this.variableView = new variableViewCtor(
            this.configuration,
