 ...
 */
// (37). Telemetry.ConfigureNotebookToolCall (DATASCIENCE.JUPYTER_CONFIGURE_NOTEBOOK_TOOL_CALL)
// Telemetry sent with details of LM toolcalls.
/* __GDPR__
   "DATASCIENCE.JUPYTER_CONFIGURE_NOTEBOOK_TOOL_CALL" : {
     ...
     "installedPythonExtension": {"classification":"SystemMetaData","purpose":"PerformanceAndHealth","comment":"Whether the tool installed Python extension or not","owner":"donjayamanne"},
     "isPython": {"classification":"SystemMetaData","purpose":"PerformanceAndHealth","comment":"Whether this is a Python notebook/kernel or not.","owner":"donjayamanne"},
     "createdEnv": {"classification":"SystemMetaData","purpose":"PerformanceAndHealth","comment":"Whether a new Env was created","owner":"donjayamanne"},
     "${include}": [
       "${F1}"
 ...
 */
// (38). Telemetry.JupyterNotebookExecutionPerformance (DATASCIENCE.JUPYTER_JUPYTER_NOTEBOOK_EXEC_PERFORMANCE)
 ...
 */
// (39). Telemetry.JupyterKernelApiAccess (DATASCIENCE.JUPYTER_KERNEL_API_ACCESS)
 ...
 */
// (40). Telemetry.JupyterKernelApiUsage (DATASCIENCE.JUPYTER_KERNEL_API_USAGE)
 ...
 */
// (41). Telemetry.KernelCodeCompletion (DATASCIENCE.JUPYTER_KERNEL_CODE_COMPLETION)
 ...
 */
// (42). Telemetry.KernelCodeCompletionCannotResolve (DATASCIENCE.JUPYTER_KERNEL_CODE_COMPLETION_CANNOT_RESOLVE)
 ...
 */
// (43). Telemetry.JupyterKernelFilterUsed (DATASCIENCE.JUPYTER_KERNEL_FILTER_USED)
 ...
 */
// (44). Telemetry.JupyterKernelHiddenViaFilter (DATASCIENCE.JUPYTER_KERNEL_HIDDEN_VIA_FILTER)
 ...
 */
// (45). Telemetry.JupyterKernelSpecEnumeration (DATASCIENCE.JUPYTER_KERNEL_SPEC_FETCH_FAILURE)
 ...
 */
// (46). Telemetry.JupyterKernelStartupHook (DATASCIENCE.JUPYTER_KERNEL_STARTUP_HOOK)
 ...
 */
// (53). Telemetry.JupyterUriCanBeParsedAsUri (DATASCIENCE.JUPYTER_URI_CAN_BE_PARSED_AS_URI)
// Telemetry to verify whether we can use Uri instead of url-parse
/* __GDPR__
   "DATASCIENCE.JUPYTER_URI_CAN_BE_PARSED_AS_URI" : {
     "failureReason": {"classification":"PublicNonPersonalData","purpose":"FeatureInsight","comment":"Reason for failure to compare Uri with url-parse.","owner":"donjayamanne"},
     "${include}": [
       "${F1}"
 ...
 */
// (162). Telemetry.InvokeTool (InvokeTool)
// Telemetry sent with details of LM toolcalls.
/* __GDPR__
   "InvokeTool" : {
 ...
 */
// (163). EventName.OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_ERROR (OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_ERROR_EX)
 ...
 */
// (164). EventName.OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_REQUEST (OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_REQUEST_EX)
 ...
 */
// (165). EventName.OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_SUCCESS (OPEN_DATAVIEWER_FROM_VARIABLE_WINDOW_SUCCESS_EX)
 ...
 */
// (166). Telemetry.PlotViewerWebviewLoaded (PLOTVIEWER.WEBVIEW_LOADED)
