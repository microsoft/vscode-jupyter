...
| `Jupyter: Export to HTML`                        | Create a presentation-friendly version of your notebook in HTML        |
| `Jupyter: Export to PDF`                         | Create a presentation-friendly version of your notebook in PDF         |
