...
import { getEnvironmentVariable, getOSType, getUserHomeDir, OSType } from '../../platform/common/utils/platform';
import { arePathsSame, isParentPath, pathExists } from '../../platform/common/platform/fileUtils';
