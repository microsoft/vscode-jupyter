...
// import { IJupyterConnection, IJupyterSessionManagerFactory } from '../../datascience/types';
...
//         const connectionInfo = connections.find(item => item.fileScheme.toLowerCase() === document.uri.scheme.toLowerCase());
//         if (!connectionInfo){
//             return [];
//         }
...
//     }
//     @captureTelemetry(Telemetry.KernelProviderPerf)
//     public async provideKernelsOld(
//         document: NotebookDocument,
//         token: CancellationToken
//     ): Promise<VSCodeNotebookKernelMetadata[]> {
//         const connections = await this.authServiceProvider.getRemoteConnections();
