...
export enum Telemetry {
    ...
    GetPasswordOrKerberosAttempt = 'DATASCIENCE.GET_PASSWORD_OR_KERBEROS_ATTEMPT',
    GetPasswordFailure = 'DS_INTERNAL.GET_PASSWORD_FAILURE',
    GetPasswordSuccess = 'DS_INTERNAL.GET_PASSWORD_SUCCESS',
    GetKerberosFailure = 'DS_INTERNAL.GET_KERBEROS_FAILURE',
    GetKerberosSuccess = 'DS_INTERNAL.GET_KERBEROS_SUCCESS',
