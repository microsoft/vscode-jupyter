...
export enum Telemetry {
    ...
    JupyterBeforeCreateSessionHook = 'DATASCIENCE.JUPYTER_BEFORE_CREATE_SESSION_HOOK',
    JupyterAfterStartSessionHook = 'DATASCIENCE.JUPYTER_AFTER_START_SESSION_HOOK',
