...
//                         const reactEditor = currentEditor!.instance() as any;
...
//                         // Verify cell content
//                         const reactEditor = editorEnzyme!.instance() as any;
//                         const editor = reactEditor.state.editor;
//                         if (editor) {
...
//                         update = waitForMessage(ioc, InteractiveWindowMessages.FocusedCellEditor);
//                         let monacoEditor = getNativeFocusedEditor(wrapper)!.instance() as any;
...
//                         update = waitForMessage(ioc, InteractiveWindowMessages.FocusedCellEditor);
//                         monacoEditor = getNativeFocusedEditor(wrapper)!.instance() as any;
//                         monacoEditor.getCurrentVisibleLine = () => 0;
//                         monacoEditor.getVisibleLineCount = () => 1;
...
//                             update = waitForMessage(ioc, InteractiveWindowMessages.FocusedCellEditor);
//                             const monacoEditor = getNativeFocusedEditor(wrapper)!.instance() as any;
//                             monacoEditor.getCurrentVisibleLine = () => 0;
//                             monacoEditor.getVisibleLineCount = () => 1;
...
//                         const monacoEditorComponent = wrapper.find(NativeCell).at(1).find(undefined as any).first();
//                         const editor = (monacoEditorComponent.instance().state as any).editor!;
...
//                         assert.ok(isCellFocused(wrapper, 'NativeCell', 1));
//                         assert.equal(wrapper.find(NativeCell).at(1).find(undefined as any).length, 1);
...
//                         assert.ok(isCellMarkdown(wrapper, 'NativeCell', 1), '1st cell is not markdown');
//                         assert.equal(wrapper.find(NativeCell).at(1).find(undefined as any).length, 0);
...
//                         const monacoEditor = editor!.instance() as any;
