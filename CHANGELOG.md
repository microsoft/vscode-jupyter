...
## 2021.8.2 (22 July 2021)

### Fixes

1. Fix for existing windows not opening when being put into the new native notebook UI
   ([#6735](https://github.com/Microsoft/vscode-jupyter/issues/6735))
